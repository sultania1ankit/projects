...
header_text = "COLD CAN ANALYSER"

info_text = "1: Non-Static masking." +\
    "\n2: Decreasing value masking.(Not yet handling roll over from FF -> 00)" +\
    "\n3: Prepare static mask." +\
    "\n4: Apply static mask." +\
    "\nr: Reset mask, b: Binary, h:Hexadecimal" +\
    "\nd: Display masked data and pause filteration process.                           -> l:Lock keyboard"
...
display_head(header_text, HEADER_COLOR, TERMINAL_WIDTH)
display_info_message(info_text, INFO_COLOR, TERMINAL_WIDTH)
text_mode(1)
select_background_color(16)
draw_line_under(4, LINES_COLOR, TERMINAL_WIDTH)
draw_line_under(3, LINES_COLOR, TERMINAL_WIDTH)
sys.stdout.flush()
...
try:
    ...
    # _______________________________________________________________________________________________________________
            ...
            if can_id not in can_data:
                ...
                can_data[can_id] = [can_value, old_can_value,
                                    mask, step2_mask, deque([], 50)]
